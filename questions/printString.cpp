...
// Given a string s, t -number of thread and c-count
// You must print by taking each thread in round robin fashion print substring of length count (rotation allowed) form s
